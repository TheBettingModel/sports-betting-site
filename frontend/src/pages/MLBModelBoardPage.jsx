  ...
  return (
    <TBMPage className="mlb-v3-page">
      ...
      <TBMGrid columns={4} className="mlb-v3-kpis">
        <TBMMetric label="Moneyline Plays" value={playCount} />
          ...
          {topPlay && (
            <section className="mlb-v3-section">
              <div className="mlb-v3-section-header">
                <span>Top Play</span>
                <h2>Best MLB Moneyline Edge</h2>
              </div>
              <MLBPlayCard play={topPlay} label="Top Moneyline Play" featured />
            </section>
          )}
