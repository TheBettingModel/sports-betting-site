        ...
        <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={s.planRow}>
            ...
            <Pressable
              style={[
                s.planCard,
                { borderColor: selected === 'annual' ? C.primary : C.border, backgroundColor: C.card },
            ...
            >
              <View style={s.planBestRow}>
                <View style={[s.bestBadge, { backgroundColor: C.primary }]}>
                  <Text style={[s.bestBadgeText, { color: C.primaryFg }]}>BEST VALUE</Text>
                </View>
                <View style={[s.savingsBadge, { backgroundColor: C.goldBg }]}>
                  <Text style={[s.savingsText, { color: C.gold }]}>Save {savingsPct}%</Text>
                </View>
              </View>
              <Text style={[s.planName, { color: C.fg }]}>Annual</Text>
              <Text style={[s.planPrice, { color: selected === 'annual' ? C.primary : C.fg }]}>
                {annualPrice}
              </Text>
            ...
            <Pressable
              style={[
                s.planCard,
                { borderColor: selected === 'monthly' ? C.primary : C.border, backgroundColor: C.card },
            ...
            >
              ...
              <Text style={[s.planPrice, { color: selected === 'monthly' ? C.primary : C.fg }]}>
                {monthlyPrice}
              </Text>
...
const s = StyleSheet.create({
  ...
  closeBtn: { padding: 4 },
  trialBadge: { paddingHorizontal: 12, paddingVertical: 5, borderRadius: 20, borderWidth: 1 },
  trialBadgeText: { fontSize: 11, fontFamily: 'Inter_700Bold', letterSpacing: 1 },
  scroll: { paddingHorizontal: 20, paddingBottom: 32 },
  heroTitle: { fontSize: 32, fontFamily: 'Inter_700Bold', color: C.fg, textAlign: 'center', marginBottom: 8 },
  heroSubtitle: { fontSize: 15, fontFamily: 'Inter_400Regular', color: C.muted, textAlign: 'center', lineHeight: 22, marginBottom: 24 },
  featureCard: { borderRadius: 14, borderWidth: 1, padding: 16, marginBottom: 20, gap: 12 },
  featureRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  featureCheck: { width: 24, height: 24, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  featureText: { color: C.fg, fontSize: 14, fontFamily: 'Inter_400Regular', flex: 1 },
  ...
  planBestRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 4, marginBottom: 4 },
  bestBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  bestBadgeText: { fontSize: 9, fontFamily: 'Inter_700Bold', letterSpacing: 0.5 },
